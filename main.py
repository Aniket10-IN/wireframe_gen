...
#     """Generate design instructions using Ollama with Llama3 8B model."""
...
#     payload = {
#         "model": "llama3:8b",  # Using Llama3 8B model
#         "prompt": prompt,
#         "stream": False,
#         "options": {
#             "temperature": 0.3,
#             "num_predict": 1500  # Similar to max_tokens
#         }
#     }
...
#     except requests.exceptions.RequestException as e:
#         print(f"Error generating design instructions with Ollama: {e}")
